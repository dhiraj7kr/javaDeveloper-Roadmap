...
class Solution {
    public int minOperations(int[] nums, int k) {
        // Create a min-heap (priority queue) to efficiently get the smallest elements
        ...
        while (minHeap.size() >= 2 && minHeap.peek() < k) {
            ...
            // Combine the two smallest elements and add the result back to the heap
        ...
        // If the smallest element is still less than k, we need one more operation
